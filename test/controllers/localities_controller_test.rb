...
class LocalitiesControllerTest < ActionController::TestCase
  ...
  test "should create locality" do
    assert_difference('Locality.count') do
      post :create, locality: { code: @locality.code, garageNum: @locality.garageNum, level: @locality.level, name: @locality.name, parentId: @locality.parentId, uuid: @locality.uuid }
    end
  ...
  test "should update locality" do
    patch :update, id: @locality, locality: { code: @locality.code, garageNum: @locality.garageNum, level: @locality.level, name: @locality.name, parentId: @locality.parentId, uuid: @locality.uuid }
    assert_redirected_to locality_path(assigns(:locality))
  end
