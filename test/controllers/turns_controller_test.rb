...
class TurnsControllerTest < ActionController::TestCase
  ...
  test "should create turn" do
    assert_difference('Turn.count') do
      post :create, turn: { garage_num: @turn.garage_num, total_parking_number: @turn.total_parking_number, uuid: @turn.uuid }
    end
  ...
  test "should update turn" do
    patch :update, id: @turn, turn: { garage_num: @turn.garage_num, total_parking_number: @turn.total_parking_number, uuid: @turn.uuid }
    assert_redirected_to turn_path(assigns(:turn))
  end
